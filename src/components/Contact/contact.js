...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_k4qyrbn', 'template_n0uaduo', form.current, 'JKLUOa4TfO0vTZvPk')
            .then((result) => {
